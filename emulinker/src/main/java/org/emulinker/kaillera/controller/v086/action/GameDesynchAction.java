...
@Singleton
public class GameDesynchAction implements V086GameEventHandler<GameDesynchEvent> {
  ...
  @Override
  public void handleEvent(GameDesynchEvent desynchEvent, V086ClientHandler clientHandler) {
    handledCount++;
